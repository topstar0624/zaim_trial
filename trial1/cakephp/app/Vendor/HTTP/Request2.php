...
if (!class_exists('Net_URL2', true)) {
    require_once APP.'Vendor/Net/URL2.php';
}

/**
 * Exception class for HTTP_Request2 package
 */
require_once APP.'Vendor/HTTP/Request2/Exception.php';
...
class HTTP_Request2 implements SplSubject
{
    ...
    public function getBody()
    {
        if (self::METHOD_POST == $this->method
            ...
            if (0 === strpos($this->headers['content-type'], 'application/x-www-form-urlencoded')) {
                ...
                require_once APP.'Vendor/HTTP/Request2/MultipartBody.php';
        ...
        if (is_string($adapter)) {
            if (!class_exists($adapter, false)) {
                ...
                if (!class_exists($adapter, false)
                    ...
                    include_once APP.'Vendor/'.str_replace('_', DIRECTORY_SEPARATOR, $adapter) . '.php';
                }
                if (!class_exists($adapter, false)) {
                    throw new HTTP_Request2_LogicException(
    ...
    public function setCookieJar($jar = true)
    {
        if (!class_exists('HTTP_Request2_CookieJar', false)) {
            require_once APP.'Vendor/HTTP/Request2/CookieJar.php';
        }
