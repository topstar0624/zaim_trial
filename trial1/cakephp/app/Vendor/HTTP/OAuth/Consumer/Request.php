...
require_once APP.'Vendor/HTTP/Request2.php';
require_once APP.'Vendor/HTTP/Request2/Observer/Log.php';
require_once APP.'Vendor/HTTP/OAuth/Message.php';
require_once APP.'Vendor/HTTP/OAuth/Consumer/Response.php';
require_once APP.'Vendor/HTTP/OAuth/Signature.php';
require_once APP.'Vendor/HTTP/OAuth/Exception.php';
