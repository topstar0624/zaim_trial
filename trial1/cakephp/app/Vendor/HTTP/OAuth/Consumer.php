...
require_once APP.'Vendor/HTTP/OAuth.php';
require_once APP.'Vendor/HTTP/OAuth/Consumer/Request.php';
require_once APP.'Vendor/HTTP/OAuth/Consumer/Exception/InvalidResponse.php';
