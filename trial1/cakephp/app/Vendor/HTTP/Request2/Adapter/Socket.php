...
require_once APP.'Vendor/HTTP/Request2/Adapter.php';

/** Socket wrapper class */
require_once APP.'Vendor/HTTP/Request2/SocketWrapper.php';
...
class HTTP_Request2_Adapter_Socket extends HTTP_Request2_Adapter
{
    ...
    protected function connect()
    {
        ...
        if ($keepAlive && !empty(self::$sockets[$socketKey])
            ...
            if ($socksProxy) {
                require_once APP.'Vendor/HTTP/Request2/SOCKS5.php';
